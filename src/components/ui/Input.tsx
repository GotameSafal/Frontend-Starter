...
import { TextField as HeroTextField, Input as HeroInput, InputProps as HeroInputProps } from "@heroui/react";

export interface InputProps extends Omit<HeroInputProps, "errorMessage" | "label"> {
  error?: string;
  label?: string;
  isInvalid?: boolean;
}
      ...
      >
        ...
        <div className="relative">
          <HeroInput
            ...
            style={style}
            aria-label={label || props.placeholder || "Input field"}
            {...props}
          />
        </div>
